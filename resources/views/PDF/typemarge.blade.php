...
<body>
    ...
    <br>
    <hr>
    <h1 class="text-center mb-3">Liste de type de marge</h1>
    ...
    <table class="table table-bordered mb-5">
        <thead>
            <tr class="table-danger">
                <th scope="col">ID</th>
                <th scope="col">Nom type de marge</th>
        ...
        <tbody>
            ...
            <?php
            foreach($type_marge as $key => $type_marges){ ?>

            <tr>
                <th scope="row">{{ $type_marges->id }}</th>
                <td>{{ $type_marges->libel }}</td>
