...
$objets_credits=ObjetCredit::all();
//$html=?>
...
<body>
    ...
    <br>
    <hr>
    <h1 class="text-center mb-3">Liste des objets de credits</h1>
    ...
    <table class="table table-bordered mb-5">
        <thead>
            <tr class="table-danger">
                <th scope="col">ID</th>
                <th scope="col">Nom objet de credit</th>
        ...
        <tbody>
            ...
            <?php
            foreach($objets_credits as $key => $objets_credit){ ?>

            <tr>
                <th scope="row">{{ $objets_credit->id }}</th>
                <td>{{ $objets_credit->libel }}</td>
